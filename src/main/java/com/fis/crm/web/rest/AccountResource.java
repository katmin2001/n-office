...
import com.fis.crm.service.dto.PasswordChangeDTO;
...
import com.fis.crm.web.rest.errors.InvalidPasswordException;
import com.fis.crm.web.rest.errors.LoginAlreadyUsedException;
import com.fis.crm.web.rest.vm.KeyAndPasswordVM;
import com.fis.crm.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void saveAccount(@Valid @RequestBody AdminUserDTO userDTO) {
        ...
        Optional<User> user = userRepository.findOneByLogin(userLogin.toUpperCase());
        if (!user.isPresent()) {
    ...
    @GetMapping("/account/by-type-and-activated")
    public List<UserDTO> getListAccountTDV() {
       try{
           return userService
    ...
    @GetMapping("/account/by-type-and-role")
    public List<UserDTO> getListAccountByRole() {
        try{
    ...
    @GetMapping("/account/get_tdv")
    public List<UserDTO> getListTDV() {
        try{
            return userService.getTDV();
        } catch (Exception e){
            throw new BadRequestAlertException("", "", "");
        }
    }

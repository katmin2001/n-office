...
@Entity
@Table(name = "CONFIG_AUTO_SMS")
public class ConfigAutoSMS {
    @Id
    @Column(name = "ID", unique = true, nullable = false)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CONFIG_AUTO_SMS_GEN")
    @SequenceGenerator(name = "CONFIG_AUTO_SMS_GEN", sequenceName = "CONFIG_AUTO_SMS_SEQ", allocationSize = 1)
    private Long id;

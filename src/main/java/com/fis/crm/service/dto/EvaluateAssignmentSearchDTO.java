 ...
 */
public class EvaluateAssignmentSearchDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EvaluateAssignmentSearchDTO)) {
            return false;
        }

        return id != null && id.equals(((EvaluateAssignmentSearchDTO) o).id);
    }

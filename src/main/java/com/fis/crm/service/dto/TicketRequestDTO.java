...
public class TicketRequestDTO implements Serializable {
    ...
    private List<TicketRequestAttachmentDTO> listTicketRequestAttachmentDTOS;

    public TicketRequestDTO() {
    }

    public TicketRequestDTO(Object[] objects) {
        int i = 0;
        ...
        this.confirmDate = DataUtil.safeToDate(objects[i++]);
    ...
    public List<TicketRequestAttachmentDTO> getListTicketRequestAttachmentDTOS() {
        return listTicketRequestAttachmentDTOS;
    }

    public void setListTicketRequestAttachmentDTOS(List<TicketRequestAttachmentDTO> listTicketRequestAttachmentDTOS) {
        this.listTicketRequestAttachmentDTOS = listTicketRequestAttachmentDTOS;
    }
